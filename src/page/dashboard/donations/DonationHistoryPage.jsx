...
const DonationHistoryPage = () => {
  ...
  const { data: dataDonation, isLoading } = useGetDonationByCampaignId(id);
  ...
  return (
    <Dashboard title={dataDonation?.campaign?.title || titleLoad} detail={detail}>
      ...
      <Table isLoading={isLoading} data={filteredStatus === "All" ? dataDonation?.donations : filteredDonations} />
    </Dashboard>
  );
};
