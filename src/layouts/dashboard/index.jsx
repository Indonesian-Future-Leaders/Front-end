...
const Dashboard = ({ children, className, title, detail }) => {
  ...
  return (
    <div className="relative flex bg-light-1">
      <Sidebar openNav={openNav} setOpenNav={setOpenNav} animation={animation} isTabletMid={isTabletMid} />
      ...
      <div className="flex-1 w-full duration-300 lg:pl-64">
        <TopBar openNav={openNav} setOpenNav={setOpenNav} data={data} isLoading={isLoading} mutate={mutate} isPending={isPending} />
