    ...
    <Container>
      ...
      <div className="w-full mt-12 space-y-8 text-dark-1">
        <div className="flex flex-col gap-4 md:flex-row">
          <Image src={image_program} className="flex-1 w-full md:max-w-md lg:max-w-lg" />
          <div className="flex flex-col justify-between flex-1 gap-4 py-0 md:py-8">
            ...
            <Links ariaLabel="navigate-program" intent="secondary" to="/program" className="ms-auto">
              Read More
            </Links>
          </div>
        </div>
        <div className="flex flex-col-reverse gap-4 md:flex-row">
          <div className="flex flex-col justify-between flex-1 gap-4 py-0 md:py-8">
            ...
            <Links ariaLabel="navigate-project" intent="secondary" to="/project" className="ms-auto md:ms-0">
              Read More
            </Links>
          </div>
          <Image src={image_project} className="flex-1 w-full md:max-w-md lg:max-w-lg" />
        </div>
      </div>
    </Container>
  );
